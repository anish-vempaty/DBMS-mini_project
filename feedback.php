...
<section class="ftco-section contact-section ftco-degree-bg">
      <div class="container">
      <div class="col-md-8" id="feedback_msg">
         <!--Alert from signup form-->
       </div>
        <div class="row block-9">
          <div class="col-md-6 pr-md-5">
            <form id="feedback_form" onsubmit="return false" class="was-validated">
              ...
              <div class="form-group">
                <input type="text" class="form-control field-border" name="event_name" placeholder="event name" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control field-border" name="Feedback" placeholder="feedback" required>
              </div>

              <div class="form-group">
                <input  value="Submit" type="submit" name="feedback_button" class="btn btn-primary py-3 px-5 " required>
              </div>
            </form>
